...
const MOOD_GENRE_MAP: Record<string, string[]> = {
  'фокус': ['Ambient', 'Lo-Fi', 'Classical Piano'],
  'концентрац': ['Ambient', 'Lo-Fi', 'Classical Piano'],
  'работ': ['Lo-Fi', 'Ambient'],
  'учеб': ['Lo-Fi', 'Classical Piano'],
  'вечер': ['Jazz Noir', 'Lo-Fi'],
  'ноч': ['Synthwave', 'Minimal Techno'],
  'спорт': ['Minimal Techno', 'Deep House'],
  'бег': ['Minimal Techno', 'Deep House'],
  'спокой': ['Ambient', 'Classical Piano'],
  'чтени': ['Classical Piano', 'Ambient'],
  'вечеринк': ['Deep House', 'Synthwave'],
  'груст': ['Jazz Noir', 'Post-Rock'],
  'дожд': ['Lo-Fi', 'Ambient'],
};
